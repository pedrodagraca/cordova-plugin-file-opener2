...
This is a fork of pwlin/cordova-plugin-file-opener2 version 3.0.5 where I have removed reference to android.permission.REQUEST_INSTALL_PACKAGES from plugins.xml
